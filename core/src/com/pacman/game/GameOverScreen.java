...
//        music.play();
    ...
    public void render(float delta) {
        ...
        batch.begin();
        font96.draw(batch, "Game Over", 0, 640, 1280, 1, false);
        font32.draw(batch, statisticBuilder, 0, 480, 640, 1, false);
        font32.draw(batch, highScoreBuilder, 640, 480, 640, 1, false);
        batch.end();
        stage.draw();
    }
    ...
    public void createGUI() {
        ...
        field.setWidth(400);
        field.setPosition(640 - 400 / 2 - 200, 280);
        ...
        btnRestartGame.setPosition(640 - 160, 160);
        btnReturnToMenu.setPosition(640 - 160, 40);
        btnSaveResults.setPosition(640 + 420 / 2 + 40 - 200, 260);
